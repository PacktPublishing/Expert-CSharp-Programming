...
public static class TrafficLightWithTypes
{
    ...
    { 
        return light switch
        {
            ...
            { Current: GreenBlinking, BlinkCount: >= 3 } => light with { Current = Amber, Previous = light.Current, Duration = TimeSpan.FromSeconds(1) },
