...
public class CodeBreakerTimer(CodeBreaker6x4GameRunner runner, ILogger<CodeBreakerTimer> logger)
{
    private readonly CodeBreaker6x4GameRunner _gameRunner = runner;
    ...
    public Guid Start(int threads, int delaySecondsBetweenGames, int numberGames, int thinkSeconds)
    {
