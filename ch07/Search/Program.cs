...
var racer1 = racers.LinearSearch(r => r.Country == "Austria");

var racer2 = racers.Find(r => r.FirstName == "James" && r.LastName == "Hunt");

if (racer2 is null) return;
racers.Sort();
int index = racers.BinarySearch1(racer2);
HashSet<Racer> hashSet = new(racers);
