...
public class Game6x4 : IGame<string, ColorGameResult>
{
    ...
    public ColorGameResult SetMove(string[] guesses)
    {
...
public readonly record struct ColorGameResult(int CorrectPosition, int IncorrectPosition);
